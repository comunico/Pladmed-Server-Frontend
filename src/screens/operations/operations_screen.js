...
function OperationsScreen() {
    ...
    const showDescargarResultados = (result) => {
        console.log("showDescargar: " + result);
    ...
    const showResults = () => {
        ...
        console.log("showResults: " + resultFile);
                ...
                <ListGroup.Item key={idx}>
                    <Row className={styles.operationInfo}>
                        ...
                        <Col xl={10} lg={10} md={10} sm={10} xs={10}>
                            <h6>
                                Id: <Badge bg="secondary">{op["_id"]}</Badge>
                            </h6>
                            <h6>
                                Fecha de creación: <Badge bg="secondary">{op["creation_date"]}</Badge>
                            </h6>
                            <h6>
                                Operación: <Badge bg="secondary">{op["operation"]}</Badge>
                            </h6>
                            <h6>
                                Créditos: <Badge bg="secondary">{op["credits"]}</Badge>
                            </h6>
                            <Accordion>
                                <Card>
                                    <Card.Header >
                                    ...
                                    <Accordion.Collapse eventKey={String(idx)}>
                                        ...
                                        <ListGroup>
                                            <ListGroup.Item>
                                                ...
                                                <div>
                                                    <pre>
                                                        {JSON.stringify(op["probes"], null, 2)}
                                                    </pre>
                                                </div>
                                            </ListGroup.Item>
                                        </ListGroup>
                                    ...
                                    <Accordion.Collapse eventKey={String(idx)}>
                                        ...
                                        <ListGroup>
                                            <ListGroup.Item>
                                                ...
                                                <div>
                                                    <pre>
                                                        {JSON.stringify(op["results"], null, 2)}
                                                    </pre>
                                                </div>
                                            </ListGroup.Item>
                                        </ListGroup>
                            ...
                            <div>
                                {showDescargarResultados(op["results"])}
                            </div>
